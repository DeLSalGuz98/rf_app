    ...
    <div className="">
      <Routes>
        ...
        <Route path="/rf" element={<LayoutNavApp/>}>
          ...
          <Route path="proyecto/:idProyecto/gasto/:idGasto" element={
            <ProtectedRoute>
              <EditExpenditureProyect/>
            </ProtectedRoute>
          } />
          <Route path="proyecto/:idProyecto/editar-datos" element={
            <ProtectedRoute>
              <EditProjectData/>
            </ProtectedRoute>
          } />
          ...
          <Route path="editar-documento/:idTaxDocument" element={
            <ProtectedRoute>
              <EditTaxDocument/>
            </ProtectedRoute>
          } />
